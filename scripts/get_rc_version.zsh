...
curl -sSf -u "$JFROG_USER:$JFROG_PASS" -O 'https://cboost.jfrog.io/artifactory/private-helium/com/chartboost/helium-adapter-meta-audience-network/maven-metadata.xml'
